 ...
 * as event bus of our application and 'NaluSimpleApplicationLoader'
 * as loader!</p>
 ...
 */
@Application(shell = ShellPresenter.class,
//  eventBus = Mvp4g2SimpleApplicationUsingElementoAndEventHandlerAnnotationEventBus.class,
