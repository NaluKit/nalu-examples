...
@CompositeController(componentInterface = IAddressComponent.class, component = AddressComponent.class)
public class AddressComposite
    extends AbstractAppCompositeController<IAddressComponent>
