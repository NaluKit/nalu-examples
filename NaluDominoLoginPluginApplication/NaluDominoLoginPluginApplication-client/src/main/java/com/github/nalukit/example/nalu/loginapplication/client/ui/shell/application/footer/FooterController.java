...
package com.github.nalukit.example.nalu.loginapplication.client.ui.shell.application.footer;
...
@Controller(route = "/[loginShell|applicationShell]",
            selector = "footer",
            componentInterface = com.github.nalukit.example.nalu.loginapplication.client.ui.shell.application.footer.IFooterComponent.class,
