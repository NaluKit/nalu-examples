package de.gishmo.gwt.example.nalu.simpleapplication.client.cell;

import com.google.gwt.cell.client.AbstractCell;
import com.google.gwt.safehtml.shared.SafeHtmlBuilder;

public class HoursMinutesCell extends AbstractCell<Integer> {
    ...
    public static String formatHoursMinutes(int minutes) {
    	...
    	if (remain < 10) {
    		result.append(":0").append(remain);
    	} else {
    		result.append(":").append(remain);
    	}
