...
public class DashboardComponent
    extends AbstractComponent<IDashboardComponent.Controller, Widget>
  ...
  private void initLast28SummaryTable() {
    last28SummaryTable.getTableTitle()
                      .setText("Flighthours summaries for last 28 days.");
  ...
  public void updateFlightHourSummaryTable(List<FlightHoursSummary> data) {
    last28SummaryTable.setRowData(0,
                                  data);
