...
public class FakedMailServer {
  ...
  private final String[]        fragments    = new String[]{
    ...
    + "arrangement that will protect you from any breach of the law. Please " + "get in touch with me urgently by E-detail and "
    ...
    "********************************************************************<br>" + " Original filename: detail.zip<br>"
    ...
    + " by the virus and not a person - treat this message as you would<br>" + " any other junk detail (spam).<br>"
