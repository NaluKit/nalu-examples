...
package com.github.nalukit.example.nalu.simpleapplication.client.ui.content.compositetest.controller.composites01;
...
@Controller(route = "/application/test/composite01/conditional/:config",
            selector = "content",
            componentInterface = IComposites01Component.class,
            component = Composites01Component.class)
@Composites({ @Composite(name = "composite01",
              ...
              @Composite(name = "composite03",
                         ...
                         condition = CompositesCondition.class) })
public class Composites01Controller
    extends AbstractComponentController<NaluSimpleApplicationContext, IComposites01Component, HTMLElement>
    implements IComposites01Component.Controller {

  @SuppressWarnings("unsued")
  private String config;

  public Composites01Controller() {
  }
